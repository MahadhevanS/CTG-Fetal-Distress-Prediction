"""
Training & Stratified 5-Fold Patient-Level CV Script for PatchCTG Encoder
========================================================================

Phase 3 Model 6: Benchmarking PatchCTGEncoder on CTG Fetal Distress Dataset.
...
def main():
    parser = argparse.ArgumentParser(description="Benchmarking PatchCTG Encoder")
    ...
    print(f"Executing PatchCTG Benchmark on device: {device}")
    ...
    for fold, (train_idx, val_idx) in enumerate(sgkf.split(X, y, groups=patient_ids), 1):
        ...
        model = PatchCTGForClassification(encoder, hidden_dim=64, dropout=0.2).to(device)
        ...
        for epoch in epoch_pbar:
            ...
            if val_metrics['auroc'] > best_val_auroc:
                ...
                ckpt_path = os.path.join(args.checkpoint_dir, f"patchctg_fold_{fold}_best.pth")
    ...
    print(f"\nPatchCTG Encoder Total Trainable Parameters: {total_params:,}")
    print("=================================================================\n")
