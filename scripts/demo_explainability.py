...
Runs the deliverable model (inverse_freq) over the test set, produces an
explanation for every window, prints worked examples, and then reports whether
the explanations are FAITHFUL -- i.e. whether the FIGO findings the narrative
cites actually track the model's risk score, or are merely plausible-looking
decoration presented alongside an unrelated number.
"""
import os, sys
...
THRESH = 0.365   # ~80% sensitivity operating point measured on this model
